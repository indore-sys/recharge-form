        ...
        * {
        ...
        @media print {
            * {
            ...
            /* Hide header completely in print */
            .header {
                display: none !important;
            }

            /* Hide all interactive / non-content elements */
            .header-actions,
            .btn-pdf,
            .status-form,
            .btn-delete,
            ...
            /* Force light background on dark cards */
            .section,
            .content-card,
            .client-info,
            .field-group {
        ...
        @media not print {
            /* keep all content visible in non-print view to support PDF generation */
        }

        /* Masonry-style layout for section cards (eliminates gaps) */
        #pdfContent {
            column-count: 2;
            column-gap: 24px;
            width: 100%;
        ...
        #pdfContent > .client-info,
        #pdfContent > .section:first-of-type {
            column-span: all;
            display: block;
            width: 100%;
        }
...
<body>
    <header class="header">
        <div class="header-content">
            <h1><span class="header-brand">Recharge</span> <span class="header-sub">Client review ·
                    <?php echo htmlspecialchars($client['client_id']); ?></span></h1>
            <div class="header-actions">
                <a href="index.php" class="btn btn-secondary"><span class="material-symbols-outlined"
                        style="font-size:1.1rem;">arrow_back</span> Dashboard</a>
                <button type="button" onclick="generatePDF(event)" class="btn btn-pdf"><span
                        class="material-symbols-outlined" style="font-size:1.1rem;">picture_as_pdf</span> Download
                    PDF</button>
                <button type="button" onclick="deleteClient()" class="btn btn-delete"><span
                        class="material-symbols-outlined" style="font-size:1.1rem;">delete</span> Delete</button>
            </div>
        </div>
    </header>
                    ...
                    <div class="detail-value">
                        <span class="status-form">
                            <span style="padding: 4px 10px; border-radius: 12px; font-size: 15px; font-weight: 500; 
                                ...
                                elseif ($client['status'] === 'Hold')
                                    echo 'background: #fce4ec; color: #c2185b;';
        ...
        <?php if ($is_website): ?>
                ...
                <div class="section-content">
                    <div class="field-grid">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value"><?php echo displayValue($form_data['brandShortDescription'] ?? ''); ?>
                            </div>
                        </div>
                        <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            ...
                            <?php echo displayValue($form_data['targetAudience'] ?? ''); ?><br>
                            <strong>Visitor Problem:</strong>
                            <?php echo displayValue($form_data['visitorProblem'] ?? ''); ?><br>
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            ...
                            <?php if (!empty($form_data['domainRegistrationSource'])): ?>
                                ...
                                <?php echo displayValue($form_data['domainRegistrationSource']); ?><br>
                            <?php endif; ?>
                            <?php if (!empty($form_data['domainManagementPreference'])): ?>
                                <strong>Domain Handling:</strong>
                                <?php echo displayValue($form_data['domainManagementPreference']); ?><br>
                            <?php endif; ?>
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            ...
                            <?php if (!empty($form_data['hostingProvider'])): ?>
                                ...
                                <?php echo displayValue($form_data['hostingProvider']); ?><br>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($form_data['hostingUsername'])): ?>
                                <strong>Hosting Username:</strong>
                                <?php echo displayValue($form_data['hostingUsername']); ?><br>
                            <?php endif; ?>
                            <?php if (!empty($form_data['hostingPassword'])): ?>
                                <strong>Hosting Password:</strong> <span
                                    style="background: #fff3cd; padding: 2px 6px; border-radius: 3px; font-family: monospace;"><?php echo displayValue($form_data['hostingPassword']); ?></span><br>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($form_data['getspaceRegistrationEmail'])): ?>
                                <br><strong>Getspace Email:</strong>
                                <?php echo displayValue($form_data['getspaceRegistrationEmail']); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value">
                                ...
                                <?php if (!empty($form_data['domainPassword'])): ?>
                                    <strong>Domain Password:</strong> <span
                                        style="background: #fff3cd; padding: 2px 6px; border-radius: 3px; font-family: monospace;"><?php echo displayValue($form_data['domainPassword']); ?></span><br>
                                <?php endif; ?>
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            <?php if (!empty($form_data['hasSSL'])): ?>
                                ...
                                <?php else: ?>
                                    ...
                                    <?php if (!empty($form_data['sslPreferredProvider'])): ?>
                                        ...
                                        <?php echo displayValue($form_data['sslPreferredProvider']); ?><br>
                                    <?php endif; ?>
                                <?php endif; ?>
                            <?php else: ?>
                            ...
                            <?php if (!empty($form_data['securityRequirements'])): ?>
                                ...
                                <?php echo displayValue($form_data['securityRequirements']); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            ...
                            <?php if (!empty($form_data['designComments'])): ?>
                                <strong>Design Comments:</strong>
                                <?php echo nl2br(htmlspecialchars($form_data['designComments'])); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    ...
                    <div class="subsection">
                        <h4
                            style="color: #2c3e50; border-bottom: 2px solid #3498db; padding-bottom: 5px; margin-bottom: 15px;">
                            🎨 BRANDING INFORMATION</h4>
                        <div class="field-grid">
                            <div class="field-group">
                                <div class="field-label">Company Name</div>
                                <div class="field-value">
                                    <?php echo displayValue($form_data['companyName'] ?? 'Not Provided'); ?>
                                </div>
                            </div>
                            <div class="field-group">
                                <div class="field-label">Tagline/Slogan</div>
                                <div class="field-value">
                                    <?php echo displayValue($form_data['tagline'] ?? 'Not Provided'); ?>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="field-grid">
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    <?php echo displayValue($form_data['hasLogo'] ?? 'Not Provided'); ?>
                                </div>
                            </div>
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    ...
                                    <?php if ($isImageFile): ?>
                                        <div style="margin-bottom: 15px;">
                                            ...
                                            <div
                                                style="display: none; padding: 20px; background: #f8f9fa; border: 1px solid #ddd; border-radius: 8px;">
                                    ...
                                    <div style="display: flex; align-items: center; gap: 10px; flex-wrap: wrap;">
                                        ...
                                        <span
                                            style="font-size: 12px; color: #999; background: #e9ecef; padding: 2px 6px; border-radius: 4px;">
                                        ...
                                        <a href="../download_asset.php?client_id=<?php echo urlencode($client['client_id']); ?>&type=logo&download=1"
                                            style="display: inline-block; padding: 8px 16px; background: #28a745; color: white; text-decoration: none; border-radius: 6px; font-size: 18px; font-weight: 600; transition: background 0.3s;"
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    <?php if (!empty($form_data['temporaryLogoText'])): ?>
                                        <strong>Temporary Logo Text:</strong>
                                        <?php echo displayValue($form_data['temporaryLogoText']); ?><br>
                                    <?php endif; ?>
                                    <?php if (!empty($form_data['professionalLogoText'])): ?>
                                        <strong>Professional Logo Text:</strong>
                                        <?php echo displayValue($form_data['professionalLogoText']); ?><br>
                                    <?php endif; ?>
                                    <?php if (!empty($form_data['professionalLogoDescription'])): ?>
                                        <strong>Professional Logo Brief:</strong>
                                        <?php echo nl2br(htmlspecialchars($form_data['professionalLogoDescription'])); ?>
                                    <?php endif; ?>
                                </div>
                            </div>
                        <?php endif; ?>
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value">
                                <?php echo displayValue($form_data['brandGuidelines'] ?? 'Not Provided'); ?>
                            </div>
                        </div>
                        <div class="field-group">
                        ...
                        <?php if (!empty($form_data['businessAssetsFile'])): ?>
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    ...
                                    <strong>Type:</strong>
                                    <?php echo displayValue($form_data['businessAssetsFile_type'] ?? ''); ?><br>
                                    ...
                                    <?php else: ?>
                                        <span style="color: #7f8c8d; font-style: italic;">Business assets data not available for
                                            download</span>
                                    <?php endif; ?>
                                </div>
                            </div>
                        ...
                        <?php if ($addCompanyDetails === 'yes'): ?>
                            <div
                                style="background: #f8f9fa; padding: 15px; border-radius: 8px; margin-top: 10px; border: 1px solid #dee2e6;">
                                <div class="field-grid">
                                    <div class="field-group">
                                        <div class="field-label">Company Code</div>
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['companyCode'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                    <div class="field-group">
                                        <div class="field-label">GST / VAT Number</div>
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['gstNumber'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="field-grid">
                                    <div class="field-group">
                                        ...
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['registrationNumber'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                    <div class="field-group">
                                        <div class="field-label">Bank Account Number / IBAN</div>
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['bankAccount'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="field-grid">
                                    <div class="field-group">
                                        ...
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['bankName'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                    <div class="field-group">
                                        <div class="field-label">IFSC / SWIFT Code</div>
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['ifscCode'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="field-group">
                                    ...
                                    <div class="field-value">
                                        <?php echo displayValue($form_data['companyAddress'] ?? 'Not Provided'); ?>
                                    </div>
                                </div>
                                <div class="field-grid">
                                    <div class="field-group">
                                        ...
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['city'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                    <div class="field-group">
                                        <div class="field-label">State</div>
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['state'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="field-grid">
                                    <div class="field-group">
                                        ...
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['country'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                    <div class="field-group">
                                        <div class="field-label">Pincode</div>
                                        <div class="field-value">
                                            <?php echo displayValue($form_data['pincode'] ?? 'Not Provided'); ?>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="subsection">
                        <h4
                            style="color: #2c3e50; border-bottom: 2px solid #e74c3c; padding-bottom: 8px; margin-bottom: 18px;">
                            📄 CONTENT COLLECTION</h4>
                        <div class="field-group">
                            <div class="field-label">Content Ready Status</div>
                            <div class="field-value">
                                <?php echo displayValue($form_data['contentReady'] ?? 'Not Provided'); ?>
                            </div>
                        </div>
                        <div class="field-group">
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value"><?php echo displayValue(implode(', ', $form_data['headerPages'] ?? [])); ?>
                        </div>
                    </div>

                    <div class="field-group">
                        <div class="field-label">Footer Pages</div>
                        <div class="field-value"><?php echo displayValue(implode(', ', $form_data['footerPages'] ?? [])); ?>
                        </div>
                    </div>
                                        ...
                                        <?php if ($isContactForm): ?>
                                            ...
                                            <?php if (!empty($form_data['pageHeadings'][$pageName]) || !empty($form_data['pageSubheadings'][$pageName]) || !empty($content)): ?>
                                                <div class="content-card__section content-card__section--copy">
                                                    <h5 style="margin: 0 0 14px 0; color: #2c3e50; font-size: 16px;">📝 Contact Page Content
                                                    </h5>
                                            ...
                                            <div class="content-card__section content-card__section--settings">
                                                <h5 style="margin: 0 0 14px 0; color: #2c3e50; font-size: 16px;">📧 Contact Form
                                                    Configuration</h5>
                                                ...
                                                <?php if (!empty($form_data['contactFormTitle'])): ?>
                                                    <div style="margin-bottom: 14px;">
                                                        ...
                                                        <div class="content-card__value">
                                                            <?php echo htmlspecialchars($form_data['contactFormTitle']); ?>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                ...
                                                <?php if (!empty($form_data['contactFormSubmitText'])): ?>
                                                    <div style="margin-bottom: 14px;">
                                                        ...
                                                        <div class="content-card__value">
                                                            <?php echo htmlspecialchars($form_data['contactFormSubmitText']); ?>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                ...
                                                <?php if (!empty($form_data['contactFormAdminEmail'])): ?>
                                                    <div style="margin-bottom: 14px;">
                                                        ...
                                                        <div class="content-card__value">
                                                            <?php echo htmlspecialchars($form_data['contactFormAdminEmail']); ?>
                                                        </div>
                                                    </div>
                                                <?php endif; ?>
                                                ...
                                                <?php if (empty($form_data['contactFormTitle']) && empty($form_data['contactFormSubmitText']) && empty($form_data['contactFormThankYou']) && empty($form_data['contactFormAdminEmail'])): ?>
                                                    <div style="color: #7f8c8d; font-style: italic;">No contact form settings provided.
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div style="margin-bottom: 20px;">
                                                ...
                                                <div class="content-badge-grid">
                                                    ...
                                                    foreach ($contactFields as $fieldKey => $fieldInfo):
                                                        ...
                                                        ?>
                                                        <div
                                                            style="padding: 12px 14px; background: <?php echo $isEnabled ? '#d4edda' : '#f8d7da'; ?>; border-radius: 12px; text-align: center;">
                                                            <span style="font-size: 16px;"><?php echo $fieldInfo['icon']; ?></span>
                                                            <div
                                                                style="font-size: 18px; color: <?php echo $isEnabled ? '#155724' : '#721c24'; ?>; font-weight: 600; margin-top: 4px;">
                                                                <?php echo $fieldInfo['label']; ?>:
                                                                <?php echo $isEnabled ? '✓ Yes' : '✗ No'; ?>
                                                            </div>
                                                        </div>
                                                    <?php endforeach; ?>
                                                </div>
                                                ...
                                                <div style="margin-bottom: 15px;">
                                                    ...
                                                    <ul style="list-style: none; padding: 0; margin: 0;">
                                                        <?php foreach ($customFields as $customField): ?>
                                                            <li
                                                                style="padding: 12px 14px; margin-bottom: 10px; background: white; border-radius: 10px; border: 1px solid #dee2e6;">
                                                                <strong
                                                                    style="font-size: 18px;"><?php echo htmlspecialchars($customField['label']); ?></strong>
                                                                <span
                                                                    style="color: #6c757d; font-size: 18px; margin-left: 8px;">(<?php echo htmlspecialchars($customField['type']); ?>)</span>
                                                            </li>
                                                        <?php endforeach; ?>
                                                    </ul>
                                                </div>
                                                    ...
                                                    <div style="margin-top: 8px;">
                                                        ...
                                                        if ((is_array($imageData) && (!empty($imageData['path']) || !empty($imageData['data']))) || (is_string($imageData) && !empty($imageData))):
                                                            ...
                                                            <div
                                                                ...
                                                                <span
                                                                    style="font-size: 11px; color: #999; background: #e9ecef; padding: 2px 5px; border-radius: 3px;">
                                                                ...
                                                                <a href="../download_asset.php?client_id=<?php echo urlencode($client['client_id']); ?>&type=page-image&page=<?php echo urlencode($pageName); ?>&download=1"
                                                                    ...
                                                                    target="_blank" onmouseover="this.style.background='#1e7e34';"
                                                                    onmouseout="this.style.background='#28a745';">
                                                                    📥 Download
                                                                </a>
                                                            </div>
                            ...
                            <div class="field-value">
                                <?php foreach ($form_data['pageAttachments'] as $pageName => $attachment): ?>
                                    <div style="margin-bottom: 12px; padding: 12px 14px; background: #f8f9fa; border-radius: 10px;">
                                        <strong
                                            style="text-transform: capitalize; font-size: 18px;"><?php echo htmlspecialchars($pageName); ?>:</strong><br>
                                        <?php if (is_array($attachment) && (!empty($attachment['path']) || !empty($attachment['data']))): ?>
                                            <a href="../download_asset.php?client_id=<?php echo urlencode($client['client_id']); ?>&type=page-attachment&page=<?php echo urlencode($pageName); ?>&download=1"
                                                style="color: #28a745; text-decoration: none; display: inline-flex; align-items: center; gap: 5px; padding: 8px 12px; background: #e8f5e8; border-radius: 8px; border: 1px solid #28a745; margin-top: 6px;"
                                                target="_blank">
                                                📎 <?php echo htmlspecialchars($attachment['fileName'] ?? 'Download File'); ?>
                                            </a><br>
                                        <?php else: ?>
                                            <span style="color: #28a745;">📎
                                                <?php echo htmlspecialchars($attachment['fileName'] ?? $attachment['name'] ?? 'File uploaded'); ?></span><br>
                                        <?php endif; ?>
                                        <small style="color: #6c757d; font-size: 0.98rem;">Type:
                                            <?php echo htmlspecialchars($attachment['fileType'] ?? 'Unknown'); ?></small>
                                    </div>
                                <?php endforeach; ?>
                            </div>
                        </div>
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value">
                                ...
                                <?php if (!empty($testimonialItems)): ?>
                                    ...
                                    <div style="margin-top: 15px; display: flex; flex-direction: column; gap: 15px;">
                                        <?php foreach ($testimonialItems as $item): ?>
                                            <div
                                                style="border: 1px solid #e0e0e0; border-radius: 12px; padding: 20px; background: #fafafa;">
                                                <div style="display: flex; align-items: flex-start; gap: 15px; margin-bottom: 15px;">
                                                    ...
                                                    if (!empty($imageData) || !empty($imagePath)):
                                                        ?>
                                                        <div
                                                            style="width: 80px; height: 80px; border-radius: 50%; overflow: hidden; flex-shrink: 0; background: #f0f0f0;">
                                                    ...
                                                    <div style="flex: 1;">
                                                        <div
                                                            style="font-weight: 600; font-size: 16px; color: #2c3e50; margin-bottom: 5px;">
                                                ...
                                                <?php if (!empty($item['text'])): ?>
                                                    <div
                                                        style="font-style: italic; color: #555; padding: 15px; background: white; border-radius: 8px; border-left: 3px solid #3498db; margin-bottom: 10px;">
                                ...
                                <?php if (!empty($form_data['galleryDescription'])): ?>
                                    <strong>Gallery
                                        Description:</strong><?php echo nl2br(htmlspecialchars($form_data['galleryDescription'])); ?><br>
                                <?php endif; ?>
                                <?php if (!empty($galleryItems)): ?>
                                    <strong>Gallery Images:</strong><br>
                                    <div class="field-grid"
                                        style="grid-template-columns: repeat(auto-fill, minmax(250px, 1fr)); gap: 20px; margin-top: 15px;">
                                        <?php foreach ($galleryItems as $item): ?>
                                            <div class="field-group"
                                                style="border: 1px solid #e0e0e0; border-radius: 12px; padding: 15px; background: #fafafa;">
                                                <?php
                                                ...
                                                <?php else: ?>
                                                    <div
                                                        style="text-align: center; padding: 10px 16px; background: #f8f9fa; color: #6c757d; border-radius: 8px; font-size: 18px;">
                                ...
                                <div class="field-value">
                                    <?php if (!empty($form_data['serviceDetailsFile_data'])): ?>
                                        <a href="../download_asset.php?client_id=<?php echo urlencode($client['client_id']); ?>&type=service-details&download=1"
                                            style="color: #28a745; text-decoration: none; display: inline-flex; align-items: center; gap: 5px; padding: 8px 15px; background: #e3f2fd; border-radius: 4px; border: 1px solid #28a745; margin-bottom: 10px;"
                                            target="_blank">
                                            📄 Download
                                            <?php echo htmlspecialchars($form_data['serviceDetailsFile'] ?? 'Service Details'); ?>
                                        </a><br>
                                    <?php endif; ?>
                                    <strong>File:</strong> <?php echo displayValue($form_data['serviceDetailsFile'] ?? ''); ?><br>
                                    <strong>Type:</strong>
                                    <?php echo displayValue($form_data['serviceDetailsFile_type'] ?? ''); ?><br>
            ...
            <div class="section">
                ...
                <div class="section-content">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value">
                                ...
                                <?php if (!empty($form_data['productDriveLink'])): ?>
                                    <strong>Product Drive Link:</strong> <a
                                        href="<?php echo htmlspecialchars($form_data['productDriveLink']); ?>" target="_blank">View
                                        Products</a><br>
                                <?php endif; ?>
                                            ...
                                            <div style="display: flex; align-items: flex-start; gap: 15px;">
                                                <div style="flex: 1;">
                                                    <div style="margin-bottom: 12px;">
                                                        ...
                                                        <div
                                                            style="margin-top: 4px; padding: 8px; background-color: #f5f5f5; border-radius: 4px;">
                                                    ...
                                                    <?php if (!empty($item['price'])): ?>
                                                        <div style="margin-bottom: 12px;">
                                                            ...
                                                            <div
                                                                style="margin-top: 4px; padding: 8px; background-color: #f5f5f5; border-radius: 4px; font-size: 16px; font-weight: bold; color: #2c5aa0;">
                                                    ...
                                                    <?php if (!empty($item['description'])): ?>
                                                        <div style="margin-bottom: 12px;">
                                                            ...
                                                            <div
                                                                style="margin-top: 4px; padding: 8px; background-color: #f5f5f5; border-radius: 4px; color: #666; line-height: 1.4;">
                                                        ...
                                                        <div style="margin-bottom: 12px;">
                                                            ...
                                                            <div style="margin-top: 8px;">
                                                                ...
                                                                <a href="<?php echo $imagePath; ?>"
                                                                    download="<?php echo htmlspecialchars(basename($item['image'])); ?>"
                                                                    style="padding: 8px 16px; background-color: #28a745; color: white; text-decoration: none; border-radius: 4px; font-size: 18px; display: inline-block;">
                                                                    📥 Download Image
                                                                </a>
                                                            </div>
                    ...
                    <div class="subsection">
                        <h4
                            style="color: #2c3e50; border-bottom: 2px solid #e67e22; padding-bottom: 8px; margin-bottom: 18px;">
                            🛒 ECOMMERCE SETUP</h4>
                        ...
                        <?php if (!empty($form_data['isEcommerce']) && $form_data['isEcommerce'] === 'yes'): ?>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    <?php if (!empty($form_data['shippingType'])): ?>
                                        ...
                                        <?php echo displayValue(ucfirst(str_replace('-', ' ', $form_data['shippingType']))); ?><br>
                                    <?php endif; ?>
                                    ...
                                    <?php if (!empty($form_data['shippingZones'])): ?>
                                        ...
                                        <?php echo nl2br(htmlspecialchars($form_data['shippingZones'])); ?><br>
                                    <?php endif; ?>
                                    <?php if (!empty($form_data['shippingRates'])): ?>
                                        <strong>Shipping Rates:</strong>
                                        <?php echo nl2br(htmlspecialchars($form_data['shippingRates'])); ?><br>
                                    <?php endif; ?>
                                    <?php if (!empty($form_data['deliveryTimeframes'])): ?>
                                        <strong>Delivery Timeframes:</strong>
                                        <?php echo nl2br(htmlspecialchars($form_data['deliveryTimeframes'])); ?>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-value"><?php echo displayValue(ucfirst($form_data['inventoryType'] ?? '')); ?>
                                </div>
                            </div>
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    <strong>Needs:</strong>
                                    <?php echo displayArray($form_data['ecommerceOperations'] ?? []); ?><br>
                                    <strong>Notes:</strong>
                                    <?php echo displayValue($form_data['ecommerceOperationNotes'] ?? ''); ?>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            <?php if (!empty($form_data['businessDescription'])): ?>
                                ...
                                <?php echo displayValue($form_data['businessDescription']); ?><br>
                            <?php endif; ?>
                            ...
                            <?php if (!empty($form_data['targetLocations'])): ?>
                                ...
                                <?php echo displayValue($form_data['targetLocations']); ?><br>
                            <?php endif; ?>
                            <?php if (!empty($form_data['googleBusinessProfile'])): ?>
                                <strong>Google Business Profile:</strong>
                                <?php echo displayValue($form_data['googleBusinessProfile']); ?><br>
                            <?php endif; ?>
                            ...
                            <strong>Legal / Trust Notes:</strong>
                            <?php echo displayValue($form_data['legalTrustNotes'] ?? ''); ?>
                        </div>
                    </div>
                    ...
                    <div class="subsection">
                        ...
                        <?php if (!empty($form_data['otherSocialMedia'])): ?>
                            <div class="field-group">
                                ...
                                <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['otherSocialMedia'])); ?>
                                </div>
                            </div>
                        <?php endif; ?>
                    </div>
                ...
                <div class="section-content">
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            ...
                            <?php if (!empty($form_data['openingTime']) || !empty($form_data['closingTime'])): ?>
                                <strong>Hours:</strong>
                                <?php echo displayValue(($form_data['openingTime'] ?? '') . ' - ' . ($form_data['closingTime'] ?? '')); ?>
                            <?php endif; ?>
                        </div>
                    </div>
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            ...
                            <?php echo displayValue($form_data['decisionMaker'] ?? ''); ?><br>
                            ...
                            <?php echo displayValue($form_data['bestContactTime'] ?? ''); ?><br>
                            <strong>Deadline Reason:</strong>
                            <?php echo displayValue($form_data['deadlineReason'] ?? ''); ?><br>
                            <strong>Uncertainties:</strong>
                            <?php echo displayValue($form_data['clientUncertainties'] ?? ''); ?>
                        </div>
                    </div>
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            ...
                            <?php echo displayArray($form_data['leadDestinations'] ?? []); ?><br>
                            <strong>Notification Email:</strong>
                            <?php echo displayValue($form_data['leadNotificationEmail'] ?? ''); ?><br>
                    ...
                    <div class="field-group">
                        ...
                        <div class="page-structure">
                            ...
                            $nav_structure = $form_data['navigationStructure'] ?? '';

                            if (!is_array($header_pages))
                            ...
                            if (!empty($nav_structure)) {
                                // If we have a custom navigation structure, use it for ordering
                                $order_items = explode(',', $nav_structure);
                                foreach ($order_items as $item) {
                                    ...
                                    $typeLabel = ($type === 'footer') ? 'Footer' : 'Header';
                                    
                                    // Fallback for old format (without |type)
                                    if ($type === '') {
                                        if (in_array($val, $header_pages)) {
                                            $typeLabel = 'Header';
                                        } elseif (in_array($val, $footer_pages)) {
                                            $typeLabel = 'Footer';
                                        }
                                    }
                                    
                                    $all_pages[] = ['name' => ucfirst($val), 'type' => $typeLabel];
                                }
                            } else {
                                // Fallback to default construction if navigationStructure is missing
                ...
                <div class="section-content">
                    <div class="field-grid">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value"><?php echo displayValue($form_data['app_target_audience'] ?? ''); ?>
                            </div>
                        </div>
                        <div class="field-group">
                    ...
                    <?php if (!empty($form_data['app_design_available'])): ?>
                        ...
                        <?php $designChoice = $form_data['app_design_available']; ?>

                        <?php if ($designChoice === 'yes'): ?>
                            <?php if (!empty($form_data['app_design_tool'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Design Tool Used</div>
                                    <div class="field-value"><?php
                                        $tools = is_array($form_data['app_design_tool']) ? $form_data['app_design_tool'] : [$form_data['app_design_tool']];
                                        $toolLabels = ['figma'=>'Figma','adobe-xd'=>'Adobe XD','sketch'=>'Sketch','pdf'=>'PDF / Images','other'=>'Other'];
                                        echo displayArray(array_map(fn($t) => $toolLabels[$t] ?? ucfirst($t), $tools));
                                    ?></div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_design_link'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Design File Link</div>
                                    <div class="field-value"><a href="<?php echo htmlspecialchars($form_data['app_design_link']); ?>" target="_blank" style="color:#3498db;"><?php echo htmlspecialchars($form_data['app_design_link']); ?></a></div>
                                </div>
                            <?php endif; ?>
                            <?php if (fieldAssetExists($form_data, 'app_design_file')): ?>
                                <div class="field-group">
                                    <div class="field-label">Uploaded Design File</div>
                                    <div class="field-value">
                                        <div style="border: 1px solid #e0e0e0; border-radius: 12px; padding: 15px; background: #fafafa; display: block; max-width: 100%;">
                                            <div style="font-size: 13px; color: #6c757d; margin-bottom: 10px; text-align: center; word-break: break-all;">
                                                <strong><?php echo htmlspecialchars($form_data['app_design_file'] ?? 'design-file'); ?></strong>
                                            </div>
                                            <a href="<?php echo htmlspecialchars(fieldAssetUrl($client['client_id'], 'app_design_file', true)); ?>"
                                               download="<?php echo htmlspecialchars($form_data['app_design_file'] ?? 'design-file'); ?>"
                            ...
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_design_notes'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Design Notes</div>
                                    <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_design_notes'])); ?></div>
                                </div>
                            <?php endif; ?>

                        <?php elseif ($designChoice === 'no'): ?>
                            <?php if (!empty($form_data['app_design_mood'])): ?>
                                <div class="field-group">
                                    <div class="field-label">App Style / Mood</div>
                                    <div class="field-value"><?php
                                        $moods = is_array($form_data['app_design_mood']) ? $form_data['app_design_mood'] : [$form_data['app_design_mood']];
                                        $moodLabels = ['minimal'=>'Minimal & Clean','bold'=>'Bold & Vibrant','professional'=>'Professional & Corporate','playful'=>'Playful & Fun','dark'=>'Dark Mode','luxury'=>'Luxury / Premium'];
                                        echo displayArray(array_map(fn($m) => $moodLabels[$m] ?? ucfirst($m), $moods));
                                    ?></div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_design_colors'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Preferred Color Palette</div>
                                    <div class="field-value"><?php echo displayValue($form_data['app_design_colors']); ?></div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_has_brand_guide'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Brand Guide / Logo</div>
                                    <div class="field-value"><?php echo displayValue(formatMappedValue($form_data['app_has_brand_guide'], ['yes'=>"Yes – Will share",'no'=>'No – Create from scratch'])); ?></div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_design_reference'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Design Reference Apps</div>
                                    <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_design_reference'])); ?></div>
                                </div>
                            <?php endif; ?>

                        <?php elseif ($designChoice === 'partial'): ?>
                            <?php if (!empty($form_data['app_design_ready_screens'])): ?>
                                <div class="field-group">
                                    <div class="field-label">✅ Screens / Parts Ready</div>
                                    <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_design_ready_screens'])); ?></div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_design_missing_screens'])): ?>
                                <div class="field-group">
                                    <div class="field-label">🔧 Screens / Parts Still Needed</div>
                                    <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_design_missing_screens'])); ?></div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_design_link'])): ?>
                                <div class="field-group">
                                ...
                                <div class="field-grid"
                                    ...
                                    <?php foreach ($apiFiles as $item): ?>
                                        <div class="field-group"
                                            ...
                                            <div
                                                style="font-size: 13px; color: #6c757d; margin-bottom: 10px; text-align: center; word-break: break-all;">
                                            ...
                                            <?php else: ?>
                                                <div
                                                    style="text-align: center; padding: 10px 16px; background: #f8f9fa; color: #6c757d; border-radius: 8px; font-size: 14px;">
                        ...
                        <div class="field-group">
                            ...
                            <div class="field-value">
                                <?php if (!empty($form_data['app_playstore_login'])): ?>
                                    <strong>Google Play Store Login:</strong>
                                    <?php echo displayValue($form_data['app_playstore_login']); ?><br>
                                <?php endif; ?>
                                <?php if (!empty($form_data['app_playstore_password'])): ?>
                                    <strong>Google Play Store Password:</strong>
                                    <?php echo displayValue($form_data['app_playstore_password']); ?><br>
                                <?php endif; ?>
                                <?php if (!empty($form_data['app_appstore_login'])): ?>
                                    <strong>Apple App Store Login:</strong>
                                    <?php echo displayValue($form_data['app_appstore_login']); ?><br>
                                <?php endif; ?>
                                <?php if (!empty($form_data['app_appstore_password'])): ?>
                                    <strong>Apple App Store Password:</strong>
                                    <?php echo displayValue($form_data['app_appstore_password']); ?><br>
                                <?php endif; ?>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    ...
                    <?php if (!empty($form_data['app_payment_methods'])): ?>
                        ...
                        <!-- Per-method credentials -->
                        <?php
                        $methods = is_array($form_data['app_payment_methods']) ? $form_data['app_payment_methods'] : [$form_data['app_payment_methods']];
                        ...
                        $credentialBlocks = [
                            'razorpay' => [
                                ...
                                'color' => '#3498db',
                                'fields' => [
                                    'app_payment_cred_razorpay_key_id'     => 'Key ID',
                                    'app_payment_cred_razorpay_key_secret' => 'Key Secret',
                                ]
                            ],
                            'stripe' => [
                                ...
                                'color' => '#6772e5',
                                'fields' => [
                                    'app_payment_cred_stripe_publishable_key' => 'Publishable Key',
                                    'app_payment_cred_stripe_secret_key'      => 'Secret Key',
                                ]
                            ],
                            'paypal' => [
                                ...
                                'color' => '#003087',
                                'fields' => [
                                    'app_payment_cred_paypal_client_id'     => 'Client ID',
                                    'app_payment_cred_paypal_client_secret' => 'Client Secret',
                                    'app_payment_cred_paypal_email'         => 'Merchant Email',
                                ]
                            ],
                            'upi' => [
                                'label' => '💜 UPI Credentials',
                                'color' => '#5f259f',
                                'fields' => [
                                    'app_payment_cred_upi_id'            => 'UPI ID / VPA',
                                    'app_payment_cred_upi_merchant_name' => 'Merchant Name',
                                ]
                            ],
                            'google-pay' => [
                                'label' => '🟦 Google Pay Credentials',
                                'color' => '#4285F4',
                                'fields' => [
                                    'app_payment_cred_gpay_merchant_id'   => 'Merchant ID',
                                    'app_payment_cred_gpay_merchant_name' => 'Merchant Name',
                                ]
                            ],
                            'apple-pay' => [
                                'label' => '⬛ Apple Pay Credentials',
                                'color' => '#555',
                                'fields' => [
                                    'app_payment_cred_apple_merchant_id' => 'Merchant ID',
                                    'app_payment_cred_apple_bundle_id'   => 'Domain / Bundle ID',
                                ]
                            ],
                            'credit-card' => [
                                'label' => '💳 Credit/Debit Card Gateway',
                                'color' => '#e67e22',
                                'fields' => [
                                    'app_payment_cred_card_gateway' => 'Gateway Provider',
                                    'app_payment_cred_card_api_key' => 'API Key / Merchant Account',
                                ]
                            ],
                            'cod' => [
                                ...
                                'color' => '#27ae60',
                                'fields' => [
                                    'app_payment_cred_cod_notes' => 'COD Instructions / Notes',
                                ]
                            ],
                        ];
                        ...
                        foreach ($methods as $method) {
                            if (!isset($credentialBlocks[$method])) continue;
                            $block = $credentialBlocks[$method];
                            $hasValues = false;
                            foreach ($block['fields'] as $fieldKey => $_) {
                                if (!empty($form_data[$fieldKey])) { $hasValues = true; break; }
                            }
                            if (!$hasValues) continue;
                            $hasAnyCreds = true;

                            echo '<div style="margin-top:16px; padding:16px; background:#f8f9fa; border-left:4px solid ' . htmlspecialchars($block['color']) . '; border-radius:8px;">';
                            echo '<div style="font-weight:700; font-size:15px; color:#2c3e50; margin-bottom:12px;">' . $block['label'] . '</div>';
                            echo '<div class="field-grid" style="grid-template-columns: repeat(auto-fill, minmax(220px,1fr)); gap:12px;">';
                            foreach ($block['fields'] as $fieldKey => $fieldLabel) {
                                if (empty($form_data[$fieldKey])) continue;
                                echo '<div>';
                                echo '<div style="font-size:12px; font-weight:600; color:#6c757d; text-transform:uppercase; letter-spacing:.5px; margin-bottom:4px;">' . htmlspecialchars($fieldLabel) . '</div>';
                                echo '<div style="font-size:15px; color:#2c3e50; word-break:break-all;">' . nl2br(htmlspecialchars($form_data[$fieldKey])) . '</div>';
                                echo '</div>';
                            }
                            echo '</div></div>';
                        }
                        ...
                        if (!$hasAnyCreds):
                        ?>
                            <div style="margin-top:12px; color:#7f8c8d; font-style:italic; font-size:14px;">No payment credentials provided.</div>
                        <?php endif; ?>
                    <?php endif; ?>
                ...
                <div class="section-content">
                    ...
                    <?php if (!empty($form_data['app_professionalIconDescription'])): ?>
                        <div class="field-group">
                            ...
                            <div class="field-value">
                                <?php echo nl2br(htmlspecialchars($form_data['app_professionalIconDescription'])); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <?php if (!empty($form_data['app_brandGuidelines'])): ?>
                        <div class="field-group">
                            <div class="field-label">Brand Guidelines</div>
                            <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_brandGuidelines'])); ?>
                            </div>
                        </div>
                    <?php endif; ?>
            ...
            <div class="section">
                ...
                <div class="section-content">
                    ...
                    <?php if (!empty($form_data['addAppCompanyDetails'])): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #3498db; padding-bottom: 8px; margin-bottom: 18px;">
                                🏢 Company Details</h4>
                            <div class="field-grid">
                                <div class="field-group">
                                    <div class="field-label">Company Code</div>
                                    <div class="field-value"><?php echo displayValue($form_data['app_companyCode'] ?? ''); ?>
                                    </div>
                                </div>
                                <div class="field-group">
                                    <div class="field-label">GST/VAT Number</div>
                                    <div class="field-value"><?php echo displayValue($form_data['app_gstNumber'] ?? ''); ?>
                                    </div>
                                </div>
                            </div>
                            <div class="field-group">
                                <div class="field-label">Company Address</div>
                                <div class="field-value"><?php echo displayValue($form_data['app_companyAddress'] ?? ''); ?>
                                </div>
                            </div>
                        </div>
                    <?php endif; ?>
                    ...
                    <div class="subsection">
                        ...
                        <?php if (!empty($form_data['app_iconLink'])): ?>
                            <div class="field-group">
                                ...
                                <div class="field-value"><a href="<?php echo htmlspecialchars($form_data['app_iconLink']); ?>"
                                        target="_blank"><?php echo htmlspecialchars($form_data['app_iconLink']); ?></a></div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    <div style="margin-top: 10px; display: flex; align-items: center; gap: 10px;">
                                        <span style="font-size: 18px; color: #6c757d;">
                                            File:
                                            <?php echo htmlspecialchars($form_data['app_businessAssetsFile'] ?? 'business-assets.pdf'); ?>
                                        </span>
                    ...
                    <?php if (fieldAssetExists($form_data, 'app_professionalIconReference')): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #e74c3c; padding-bottom: 8px; margin-bottom: 18px;">
                                🎨 Professional Icon Reference</h4>
                            <div class="field-group">
                                <div class="field-label">Reference Icon/Image</div>
                                <div class="field-value">
                                    <div style="margin-top: 10px;">
                                        <div
                                            style="width: 150px; height: 150px; border-radius: 8px; overflow: hidden; margin-bottom: 10px; background: #f0f0f0; display: flex; align-items: center; justify-content: center;">
                                        ...
                                        <div style="display: flex; align-items: center; gap: 10px;">
                                            <span style="font-size: 18px; color: #6c757d;">
                                                File:
                                                <?php echo htmlspecialchars($form_data['app_professionalIconReference'] ?? 'icon-reference.jpg'); ?>
                                            </span>
                    ...
                    <div class="subsection">
                        <h4
                            style="color: #2c3e50; border-bottom: 2px solid #f39c12; padding-bottom: 8px; margin-bottom: 18px;">
                            📝 Content Collection</h4>
                        <div class="field-group">
                        ...
                        <?php if (!empty($form_data['app_screenContent'])): ?>
                            <div class="field-group">
                                ...
                                <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_screenContent'])); ?>
                                </div>
                            </div>
                        <?php endif; ?>
                            ...
                            <div class="field-group">
                                ...
                                <div class="field-value">
                                    <?php foreach ($screen_contents as $screen_name => $content): ?>
                                        <div
                                            style="margin-bottom: 20px; padding: 15px; background: #f8f9fa; border-radius: 8px; border-left: 4px solid #3498db;">
                                            <h5
                                                style="margin: 0 0 10px 0; color: #2c3e50; font-size: 16px; text-transform: capitalize;">
                                                📱 <?php echo htmlspecialchars(ucwords(str_replace('_', ' ', $screen_name))); ?>
                                                Screen
                                            </h5>
                                            ...
                                            <?php if (!empty($content['title'])): ?>
                                                <div style="margin-bottom: 8px;">
                                                    ...
                                                    <span
                                                        style="color: #2c3e50; font-weight: 600;"><?php echo htmlspecialchars($content['title']); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <?php if (!empty($content['content'])): ?>
                                                <div style="margin-bottom: 8px;">
                                                    ...
                                                    <span
                                                        style="color: #2c3e50;"><?php echo nl2br(htmlspecialchars($content['content'])); ?></span>
                                                </div>
                                            <?php endif; ?>
                                            ...
                                            <?php if (!empty($content['features'])): ?>
                                                <div style="margin-bottom: 8px;">
                                                    ...
                                                    <span
                                                        style="color: #2c3e50;"><?php echo nl2br(htmlspecialchars($content['features'])); ?></span>
                                                </div>
                                            <?php endif; ?>
                    ...
                    <?php if (!empty($form_data['app_businessAddress']) || !empty($form_data['app_businessEmail']) || !empty($form_data['app_city']) || !empty($form_data['app_state']) || !empty($form_data['app_country']) || !empty($form_data['app_pincode'])): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #34495e; padding-bottom: 8px; margin-bottom: 18px;">
                                🏢 Business Information</h4>
                            <?php if (!empty($form_data['app_businessAddress'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Business Address</div>
                                    <div class="field-value">
                                        <?php echo nl2br(htmlspecialchars($form_data['app_businessAddress'])); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                    ...
                    <?php if (!empty($form_data['app_bankName']) || !empty($form_data['app_bankAccount']) || !empty($form_data['app_ifscCode'])): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #16a085; padding-bottom: 8px; margin-bottom: 18px;">
                                🏦 Banking Information</h4>
                    ...
                    <?php if (!empty($form_data['app_workingHoursMode']) || !empty($form_data['app_openingTime']) || !empty($form_data['app_closingTime']) || !empty($form_data['app_openDays'])): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #8e44ad; padding-bottom: 8px; margin-bottom: 18px;">
                                ⏰ Working Hours</h4>
                    ...
                    <?php if (!empty($form_data['app_preferredCommunication']) || !empty($form_data['app_bestContactTime'])): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #2980b9; padding-bottom: 8px; margin-bottom: 18px;">
                    ...
                    <?php if (!empty($form_data['app_assetLinks']) || !empty($form_data['app_reference_apps']) || !empty($form_data['app_additionalNotes'])): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #27ae60; padding-bottom: 8px; margin-bottom: 18px;">
                                📋 Additional Information</h4>
                            <?php if (!empty($form_data['app_assetLinks'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Asset Links</div>
                                    <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_assetLinks'])); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_reference_apps'])): ?>
                                <div class="field-group">
                                    ...
                                    <div class="field-value">
                                        <?php echo nl2br(htmlspecialchars($form_data['app_reference_apps'])); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                            <?php if (!empty($form_data['app_additionalNotes'])): ?>
                                <div class="field-group">
                                    <div class="field-label">Additional Notes</div>
                                    <div class="field-value">
                                        <?php echo nl2br(htmlspecialchars($form_data['app_additionalNotes'])); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <?php if (!empty($form_data['app_galleryTitle']) || !empty($form_data['app_galleryDescription'])): ?>
                        <div class="subsection">
                            <h4
                                style="color: #2c3e50; border-bottom: 2px solid #9b59b6; padding-bottom: 8px; margin-bottom: 18px;">
                                🖼️ Gallery</h4>
                            ...
                            <?php if (!empty($form_data['app_galleryDescription'])): ?>
                                <div class="field-group">
                                    ...
                                    <div class="field-value">
                                        <?php echo nl2br(htmlspecialchars($form_data['app_galleryDescription'])); ?>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                                ...
                                <?php foreach ($appTestimonials as $index => $testimonial): ?>
                                    <div class="field-group"
                                        ...
                                        <?php if (!empty($testimonial['text'])): ?>
                                            <div
                                                style="font-style: italic; color: #555; padding: 15px; background: white; border-radius: 8px; border-left: 3px solid #e67e22;">
            ...
            <div class="section">
                ...
                <div class="section-content">
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            <?php echo displayArray(formatAppFeatureValues($form_data['app_features'] ?? [])); ?>
                        </div>
                    </div>
                    <?php if (!empty($form_data['app_custom_features'])): ?>
                        <div class="field-group">
                            <div class="field-label">Custom Features</div>
                            <div class="field-value"><?php echo nl2br(htmlspecialchars($form_data['app_custom_features'])); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                </div>
                    ...
                    <div class="field-group">
                        ...
                        <div class="field-value">
                            <?php if (!empty($form_data['app_decisionMaker'])): ?>
                                <strong>Decision Maker:</strong>
                                <?php echo displayValue($form_data['app_decisionMaker']); ?><br>
                            <?php endif; ?>
    ...
    <script>
        function generatePDF(evt) {
            ...
            if (btn) {
                btn.innerHTML = '<span class="material-symbols-outlined" style="font-size:1.1rem;">hourglass_top</span> Preparing...';
                btn.disabled = true;
            }

            // Give browser a moment to update button UI, then print
            setTimeout(() => {
                window.print();
    ...
    <div class="modal-overlay" id="deleteModal">
        <div class="modal">
            ...
            <div class="modal-message">
                Are you sure you want to delete this client? This action cannot be undone and all data will be
                permanently removed.
            </div>
